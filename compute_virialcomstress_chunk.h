...
ComputeStyle(virialcomstress/chunk,ComputeVirialcomstressChunk)

#else

#ifndef LMP_COMPUTE_VIRIALCOMSTRESS_CHUNK_H
#define LMP_COMPUTE_VIRIALCOMSTRESS_CHUNK_H

#include "compute_chunk.h"

namespace LAMMPS_NS {

class ComputeVirialcomstressChunk : public ComputeChunk {
 public:
  ComputeVirialcomstressChunk(class LAMMPS *, int, char **);
  ~ComputeVirialcomstressChunk() override;
